...
\begin{frame}{¿Por qué estudiar lógica y conjuntos?}
    \begin{block}{Según Ferreirós}
        \textit {La lógica y los conjuntos se consideran los fundamentos de
   ...
   \end{frame}
    ...
    \begin{block}{Ejemplo estudiado desde Aristóteles}
      ...
      \textit{
        ...
        Algunos inteligentes son mujeres. \\
        Todos los hombres son inteligentes. \\
...
\begin{frame}{Ejemplo más contemporáneo}
     ...
     \end{block}
     \pause
     Supongamos que Isaac Herzog despierta una mañana en un hospital y descubre que está conectado, 
     mediante un sistema circulatorio compartido, a Donald John Trump que sufre una enfermedad renal 
     fatal. Solo el presidente de Israel tiene el tipo de sangre necesario para filtrar la sangre de Trump;
...
\begin{frame}
    \begin{block}{Deducción}
        \begin{enumerate}
            ...
            a decidir utilizar el cuerpo de Isaac Herzog.
            \pause
...
\begin{frame}{¿Qué es la teoría de conjuntos?}
    Es la teoría que no define qué es un conjunto pero nos dice qué se puede y qué no se puede hacer con esto.

    Existen diversas versiones axiomáticas para evitar las paradojas; la más extendida en la matemática contemporánea es la de Zermelo-Fraenkel
    \vspace{\baselineskip}
    \pause
...
\begin{frame}{Orígenes de la teoría de conjuntos}
    Cantor planteó los diferentes conjuntos infinitos, números transfinito y la jerarquía de los infinitos.
    \begin{center}
...
\begin{frame}{Crisis de los fundamento}
    ...
    \begin{enumerate}
        \item Logicismo, representado por Frege y Russell. Su objetivo era reducir las matemáticas
        a la lógica.
        \item Formalismo, representado por Hilbert.  Su objetivo era demostrar que las matemáticas son
        consistentes.
        \item Intuicionismo. L. E. J. Brouwer. Su objetivo es que las matemáticas deben construirse.
    \end{enumerate}
\end{frame}

\begin{frame}{Kurt Gödel}
    Demostró el teorema de incompletitud en 1931. Mostrando que ningún sistema formal, que pueda expresar y
